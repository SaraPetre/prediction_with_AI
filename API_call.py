# Observera att filen API_call.py inte gå att köra igen då API:et med min API-key inte längre är "valid" för att hämta datan igen. 
#Jag måste uppgradera till en högre "pay-plan" för att ladda ner nu.
